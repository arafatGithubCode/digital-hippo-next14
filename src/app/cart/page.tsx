...
const Page = () => {
  ...
  return (
    <div className="bg-white">
      <div className="max-w-2xl mx-auto px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
                        ...
                        <div className="w-24 h-24 relative">
                          {typeof image !== "string" && image.url ? (
                            <Image
                              ...
                              fill
                              alt="product image"
                              className="w-full h-full object-cover object-center sm:w-48 sm:h-48"
                            />
                          ) : null}
                        </div>
                      </div>

                      <div className="ml-4 flex flex-col justify-between sm:ml-6 flex-1 ">
